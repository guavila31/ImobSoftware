 ...
 * @author gusta
 */
public class InternalCadastro1 extends javax.swing.JInternalFrame {

    private static InternalCadastro1 instance;

    public static InternalCadastro1 getInstance() {
        if (instance == null) {
            instance = new InternalCadastro1();
        }
        return instance;
    }
